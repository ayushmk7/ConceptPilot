...
export default function TokenAccessPage() {
  ...
  if (validating && !error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-chart-2 to-chart-2 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm mx-auto">
            ...
            <h2 className="text-lg font-semibold text-primary mb-2">Validating your access link</h2>
            <p className="text-sm text-secondary-text">Please wait while we verify your credentials...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-chart-2 to-chart-2 flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm mx-auto">
          ...
          <h2 className="text-lg font-semibold text-primary mb-2">Invalid Access Link</h2>
