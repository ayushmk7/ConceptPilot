...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Get detailed readiness scores for a specific student across all concepts.",
        "input_schema": {
            "type": "object",
            "properties": {
                "exam_id": {"type": "string", "description": "Exam UUID"},
    ...
    },
    {
        ...
        "description": "Get ranked intervention recommendations sorted by estimated impact.",
        "input_schema": {
            "type": "object",
            "properties": {
                "exam_id": {"type": "string", "description": "Exam UUID"},
    ...
    },
    {
        ...
        "description": "Update computation parameters for an exam. Does NOT automatically recompute.",
        "input_schema": {
            "type": "object",
            "properties": {
                "exam_id": {"type": "string", "description": "Exam UUID"},
    ...
    },
    {
        ...
        "description": "Run the full readiness computation pipeline for an exam.",
        "input_schema": {
            "type": "object",
            "properties": {
                "exam_id": {"type": "string", "description": "Exam UUID"},
    ...
    },
    {
        ...
        "description": "Generate a Canvas-ready export zip bundle.",
        "input_schema": {
            "type": "object",
            "properties": {
                "exam_id": {"type": "string", "description": "Exam UUID"},
